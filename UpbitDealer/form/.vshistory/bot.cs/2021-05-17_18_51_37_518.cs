...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        {
            var log = $"[{DateTime.Now.ToShortTimeString()}] {string.Format(format, args)}{Environment.NewLine}";
        ...
        private void PointHalfStrategy()
        {
            ...
            Debug.WriteLine("이전가: {0:N0}, 현재가 {1:N0}, ratio : {2:D4}%", prevPrice, currPrice, ratio);
