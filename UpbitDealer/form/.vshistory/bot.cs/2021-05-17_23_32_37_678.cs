...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void PointHalfStrategy()
        {
            ...
            var candles = ApiData.getCandle<List<Candle>>(CoinName, candleType, 5);
            ...
            try
            {
                ...
                else if (ratio >= TriggerRatio * 1.5 && coinPrice >= 5000 && (DateTime.Now - LastSellDate).TotalMinutes >= idx)
                {
                    // 1.5배 올랐을때 코인 금액 절반 팔기
                ...
                else if (ratio <= -(TriggerRatio) && krwBalance > 5000 && (DateTime.Now - LastBuyDate).TotalMinutes >= idx)
                {
