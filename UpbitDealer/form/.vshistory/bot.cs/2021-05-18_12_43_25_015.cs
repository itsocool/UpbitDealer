...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            if (coinPrice <= Settings.Default.minTradeKRW)
            {
                // 보유코인이 최소거래금 보다 적고 현금보유가 최소거래금액 보다 많으면 산다
            }
            else if(orderChance.CoinBalance * currPrice <= Settings.Default.minTradeKRW)
