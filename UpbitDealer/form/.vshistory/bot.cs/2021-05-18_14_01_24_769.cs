...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void PostInit()
        {
            ...
            cmbCandle.DataSource = new BindingSource(CandleType.candleNames, null);
            cmbCandle.ValueMember = "Key";
            cmbCandle.DisplayMember = "Value";
            cmbCandle.SelectedValue = Settings.Default.coin;
        ...
        private void MinuteCandleByTicks()
        {
            ...
            if (result != null)
            {
                ...
                WriteLog("#### RESULT : {0}", result.ToString());
                WriteLog("#### {0} 수익 : 거래시작금액 {1:N0}, 현재평가 금액 {2:N0}, 수익금액 {3:N0}, 수익율 {4F6}", profits);
            }
