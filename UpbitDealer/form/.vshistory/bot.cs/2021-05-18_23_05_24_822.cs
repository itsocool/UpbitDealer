        ...
        private void MinuteCandleByTicks()
        {
            ...
            try
            {
                    ...
                    && currentRate >= (feeRate * 2))
                {
                    ...
                    && (buyTs.TotalSeconds >= CandleType.Minute * 30 && tradeProfitRate <= (feeRate - triggerRate)
                        || tradeProfitRate >= triggerRate + (feeRate * 2)))
                {
                    ...
                    //var krw = Convert.ToDouble(txtKRW.Text);
                    //var coinKrw = Convert.ToDouble(txtCoinBalance.Text);
                    var totalKrw = chance.KRWBalance + chance.CoinBalance;
                    //totalKrw = krw + coinKrw;
