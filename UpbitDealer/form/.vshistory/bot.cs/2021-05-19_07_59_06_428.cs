...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            var coinPrice = coinProfit.CoinVol;                                                // 코인 보유금
            var krwBalance = coinProfit.KRWBalance;                                            // 보유 현금
            var coinVol = coinProfit.CoinVol;                                                  // 보유 코인 수량
            var avgPrice = coinProfit.AvgBuyPrice;                                             // 매수 평단가
