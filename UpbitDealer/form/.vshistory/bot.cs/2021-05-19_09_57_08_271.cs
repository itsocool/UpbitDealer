...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            var currPrice = ApiData.getTicker(coinName).Value<double>("trade_price");           // 현재가
            ...
            var args = new object[] { coinName, currPrice, prevPrice, highPrice, currentRate, candlesRate, avgPrice, tradeProfitRate };
