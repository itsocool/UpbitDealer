...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            var targetProfit = avgPrice * ((triggerRate / 2) + (feeRate * 2)) / 100;
            var targetPrice = avgPrice + targetProfit;
            var target = avgPrice * coinVol

            var result = null as JObject;
            var args = new object[] { coinName, currPrice, prevPrice, highPrice, changeRate, candlesRate, avgPrice, targetPrice };
