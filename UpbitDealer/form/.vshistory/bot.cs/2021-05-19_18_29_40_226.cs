...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        {
            var idx = cmbCoin.SelectedIndex;
            var item = cmbCoin.SelectedItem as Coin;
            var bot = botBindingSource.Current as Bot;

            WriteLog("idx {0}, coin : {1}, item {2}, value {3}", idx, Coin?.Ticker, item?.Ticker, bot.Coin.Ticker);
        }

        private void rtxtCurrent_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                Coin = new Coin() { CoinName = "None", Ticker = rtxtCurrent.Text };
            }
        }
        ...
        private void PostInit()
        {
            ...
            botBindingSource.DataSource = this;
            ...
            cmbCoin.DataBindings.Add(new Binding("SelectedItem", this.botBindingSource, "Coin", true, DataSourceUpdateMode.OnPropertyChanged));
