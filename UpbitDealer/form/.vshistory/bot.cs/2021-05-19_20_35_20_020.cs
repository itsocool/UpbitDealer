...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            var avgPrice = bid.Value<double>("avg_buy_price");                                                 // 매수 평단가
            ...
            WriteLog("krwBalance {0:N0}, coinVol {1:F6}, bid avg {2:N0}, ask avg {3:N0}", krwBalance, coinVol, bid.Value<double>("avg_buy_price"), ask.Value<double>("avg_buy_price"));
