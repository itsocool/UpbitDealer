    ...
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            if (result != null)
            {
                ...
                var coinProfit = GetOrderResultAsync(uuid, coinName).GetAwaiter().GetResult();
        ...
        private async Task<Balance> GetOrderResultAsync(string uuid, string coinName)
        {
            ...
            var price = order.Value<double>("price");
            var volume = order.Value<double>("volume");
            ...
            var args = new object[] { uuid, state, price, volume, tradeCount, tradePrice, tradeVolume, tradeFunds };
            ...
            WriteLog("#### uuid {0}, state {1}, price {2:N0}, volume {3:F6}, tradeCount {4:N0}, tradePrice {5:N0}, tradeVolume {6:N0}, tradeFunds {7:N0}", args);
