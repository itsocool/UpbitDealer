...
namespace UpbitDealer.form
{
    public partial class Bot : Form
    {
        ...
        private void MinuteCandleByTicks()
        {
            ...
            var sellCoolDownSec = CandleType.Minute * 60;                                           // 매도 쿨다운 시간 (초)
            ...
            try
            {
                ...
                if (coinBalance <= minTradeKRW && krwBalance <= minTradeKRW)
                {
                    ...
                    WriteLog("#### 거래 불가(금액 부족) : 보유현금 {0}, 코인보유금 {1}, 최소 거래 금액 {2},", krwBalance, coinBalance, minTradeKRW);
                    return;
                }
                ...
                {
                    // 거래 쿨타임 일때
                    WriteLog("#### 거래 불가(쿨타임) : 보유현금 {0}, 코인보유금 {1}, 최소 거래 금액 {2},", krwBalance, coinBalance, minTradeKRW);
                    return;
                }
