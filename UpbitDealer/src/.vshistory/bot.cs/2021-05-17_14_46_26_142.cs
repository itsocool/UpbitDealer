...
namespace UpbitDealer.src
{
    ...
    {
        public static Dictionary<string, string> Coins { get; set; } = new Dictionary<string, string>()
        {
            { "BTC", "BTC 비트코인" },
            { "ETH", "ETH 이더리움" },
            { "DOGE", "DOGE 도지코인" },
        ...
        public BotSettingData setting = new BotSettingData();
        ...
        public BotSetting(string access_key, string secret_key, List<string> coinList)
        {
        ...
        public int loadFile()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        executionStr.Add(new Output(3, "Bot Execution", "Invaild macro setting file detected. Reset the macro setting."));
                        initDefaultSetting();
                    }
                }
            }
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to load macro setting (" + ex.Message + ")"));
                return -1;
            }
            try
            {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to load macro state (" + ex.Message + ")"));
                return -2;
            }
            try
            {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to load macro order (" + ex.Message + ")"));
                return -3;
            }
            try
            {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to load macro last trade (" + ex.Message + ")"));
                return -3;
            }
        ...
        public int saveFile()
        {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to save macro setting (" + ex.Message + ")"));
                return -1;
            }
            try
            {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to save macro state (" + ex.Message + ")"));
                return -2;
            }
            try
            {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to save macro order (" + ex.Message + ")"));
                return -3;
            }
            try
            {
            ...
            {
                executionStr.Add(new Output(2, "Bot Execution", "Fail to save macro last trdae (" + ex.Message + ")"));
                return -3;
            }
        ...
        public void saveBotSetting(BotSettingData setting)
        {
            this.setting = setting;
            saveFile();
        }
        public int deleteBotState(string coinName, string uuid)
        {
        ...
        public int executeCheckResult(int index)
        {
            ...
            if (tradeData.isBid)
            {
                ...
                executionStr.Add(new Output(1, "Bot Execution",
        ...
        public int executeBotSell(int index)
        {
            string coinName = coinList[index];
            ...
            for (int i = 0; i < state.Tables[coinName].Rows.Count; i++)
            {
                ...
                if (jObject == null)
                {
                    executionStr.Add(new Output(0, "Bot Execution", "Fail to sell " + coinName + " (NULL)"));
                    return -2;
                }
        ...
        private int buyDecision(int index)
        {
            ...
            {
                executionStr.Add(new Output(0, "Bot Execution",
        ...
        private int sellDecision(int index)
        {
            ...
            {
                executionStr.Add(new Output(0, "Bot Execution", "Fail to load " + coinName + " sell candle (Not Enouph)"));
                return -1;
            }
